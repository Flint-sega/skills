...
- `STATE.md` at the root, or the file a `program` verb named — the program this repo runs (`phases/program.md`). A build flight reads it to not contradict it; a program sitting reads it as its brief.
